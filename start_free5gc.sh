...
podman create --name=upf --pod $POD_NAME --privileged -v /home/cdonato/free5gc-compose/config/upfcfg.yaml:/free5gc/config/upfcfg.yaml:Z -v /home/cdonato/free5gc-compose/config/upf-iptables.sh:/free5gc/free5gc-upfd/upf-iptables-podman.sh:Z -v /dev:/dev -v /proc:/proc --network f5gcnet --network-alias upf free5gc-compose_free5gc-upf bash -c "./upf-iptables-podman.sh && ./free5gc-upfd -f /free5gc/config/upfcfg.yaml"
...
podman create --name=gnbransim --pod $POD_NAME --cap-add NET_ADMIN  --device /dev/net/tun -v /home/cdonato/free5gc-compose/config/gnbcfg.yaml:/ueransim/config/gnbcfg.yaml:Z -v /home/cdonato/free5gc-compose/config/uecfg.yaml:/ueransim/config/uecfg.yaml:Z --network f5gcnet --network-alias gnb free5gc-compose_ueransim ./nr-gnb -c ./config/gnbcfg.yaml
podman create --name=n3iwf --pod $POD_NAME --privileged --device /dev/net/tun  -e GIN_MODE=release -v /home/cdonato/free5gc-compose/config/n3iwfcfg.yaml:/free5gc/config/n3iwfcfg.yaml:Z -v /home/cdonato/free5gc-compose/config/n3iwf-ipsec.sh:/free5gc/n3iwf/n3iwf-ipsec.sh:Z --network f5gcnet --network-alias n3iwf free5gc-compose_free5gc-n3iwf bash -c "./n3iwf-ipsec.sh && ./n3iwf -n3iwfcfg /free5gc/config/n3iwfcfg.yaml"
