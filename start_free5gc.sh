...
podman create --name=amf --pod $POD_NAME -e GIN_MODE=release -v /home/cdonato/free5gc-compose/config/amfcfg.yaml:/free5gc/config/amfcfg.yaml:Z --network f5gcnet --network-alias amf --expose 8000 --expose 38412/sctp free5gc-compose_free5gc-amf ./amf -amfcfg /free5gc/config/amfcfg.yaml
...
podman create --name=ueransim --pod $POD_NAME --cap-add NET_ADMIN --device /dev/net/tun -v /home/cdonato/free5gc-compose/config/gnbcfg.yaml:/ueransim/config/gnbcfg.yaml:Z -v /home/cdonato/free5gc-compose/config/uecfg.yaml:/ueransim/config/uecfg.yaml:Z --network f5gcnet --network-alias gnb free5gc-compose_ueransim ./nr-gnb -c ./config/gnbcfg.yaml
#podman create --name=ueransim --pod $POD_NAME --cap-add NET_ADMIN --device /dev/net/tun -v /home/cdonato/free5gc-compose/config/gnbcfg.yaml:/ueransim/config/gnbcfg.yaml:Z -v /home/cdonato/free5gc-compose/config/uecfg.yaml:/ueransim/config/uecfg.yaml:Z --network f5gcnet --network-alias gnb quay.io/jnunez/ueransim:3.2.2 ./nr-gnb -c ./config/gnbcfg.yaml
